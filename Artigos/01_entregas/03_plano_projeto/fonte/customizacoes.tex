...
\makeatletter
\renewcommand{\pgfcalendarmonthshortname}[1]{%
...
\titleformat{\subsection}
  {\bfseries\MakeUppercase}   % transforma em negrito e caixa alta
  {\thesubsection}{1em}{}
...
\renewcommand{\cftsubsectionfont}{\bfseries\MakeUppercase}
